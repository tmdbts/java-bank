...
import org.academiadecodigo.javabank.persistence.model.CustomerDto;
...
public class CustomerController {
    ...
    @RequestMapping(method = RequestMethod.GET, path = {"/create/", "/edit/"})
    ...
    @RequestMapping(method = RequestMethod.POST, path = "/create/add")
    public String addCustomer(@ModelAttribute Customer customer) {

        Customer createdCustomer = customerService.createCustomer(customer);

        return "redirect:/customer/" + createdCustomer.getId();
    }
}
